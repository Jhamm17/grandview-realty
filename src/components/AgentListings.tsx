              ...
              <Link href={`/property/${listing.ListingId}`}>
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-between text-sm text-gray-500 flex-nowrap gap-2">
                    <span className="whitespace-nowrap">{listing.BedroomsTotal} beds</span>
                    <span className="whitespace-nowrap">{listing.BathroomsTotalInteger} baths</span>
                    <span className="whitespace-nowrap">{listing.LivingArea?.toLocaleString()} sq ft</span>
                  </div>
                </div>
              </Link>
            </div>
