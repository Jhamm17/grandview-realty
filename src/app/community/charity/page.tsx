      ...
      <div className="relative z-10 pt-32 pb-16">
        <div className="container-padding">
          <div className="max-w-4xl mx-auto">
            ...
            <section className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8 md:p-12">
              ...
              <div className="mt-16 relative -mx-4 md:-mx-6 lg:-mx-8">
                <div className="relative h-32 md:h-40 overflow-hidden rounded-lg">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center text-white">
                      <p className="text-2xl md:text-3xl font-bold italic" style={{ fontFamily: 'cursive' }}>
              ...
              <div className="mt-16 grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="flex flex-col justify-center p-8 bg-gray-50 rounded-lg">
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="inline-block bg-primary text-white px-10 py-4 hover:bg-primary/80 transition-colors font-semibold text-lg w-fit rounded-lg"
                  >
                    Anderson Humane
                  </a>
                </div>
              ...
              <div className="mt-16 relative -mx-4 md:-mx-6 lg:-mx-8">
                <div className="bg-[#081d36] text-white py-8 px-4 rounded-lg">
              ...
              <div className="mt-12 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                ...
                >
                  <Image
                    src="/sponsors/grandviewhomes.jpg"
                    alt="Grandview Homes"
                    width={300}
                    height={300}
                ...
                >
                  <Image
                    src="/sponsors/alastingimpression.jpg"
                ...
                >
                  <Image
                    src="/sponsors/harloconstruction.jpg"
                ...
                >
                  <Image
                    src="/sponsors/lifestyledesign.jpg"
