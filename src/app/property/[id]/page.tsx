  ...
  try {
    ...
    if (property.ListAgentFullName || property.ListAgentEmail) {
      ...
      if (property.ListAgentEmail) {
        agent = await getAgentByNameOrEmail(property.ListAgentEmail);
      }
      
      // If no email match, try by name
      if (!agent && property.ListAgentFullName) {
        // Special case for Chris Clark - try both name variations
        if (property.ListAgentFullName.includes('Christopher Clark')) {
      ...
      console.log(`[PropertyPage] Found agent:`, agent ? `${agent.name} (${agent.email})` : 'none');
    }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className="hidden lg:block lg:col-span-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="text-center">
                <div className="text-3xl font-bold text-gray-800 whitespace-nowrap">
