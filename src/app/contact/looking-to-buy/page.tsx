...
export default async function LookingToBuy() {
  return (
    <div>
      {/* Hero Section */}
      ...
      <section className="py-20">
        <div className="container-padding">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Contact Form */}
            <div>
              <h2 className="text-2xl font-bold mb-6">Tell Us About Your Home Search</h2>
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    name="message"
                    rows={4}
                    placeholder="Tell us about your ideal home, must-haves, preferences, etc."
                    className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-primary focus:border-primary"
                    required
                  ></textarea>
                </div>
