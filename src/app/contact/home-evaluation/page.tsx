      ...
      <section className="py-20">
        <div className="container-padding">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Contact Form */}
            <div>
              <h2 className="text-2xl font-bold mb-6">Request Your Free Home Evaluation</h2>
              <form className="space-y-6">
                ...
                <div>
                  <label htmlFor="square-footage" className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="market-value">Current Market Value</option>
                    <option value="listing-price">Suggested Listing Price</option>
                    <option value="investment-analysis">Investment Analysis</option>
                    <option value="refinance">Refinance Evaluation</option>
                    <option value="insurance">Insurance Evaluation</option>
                  </select>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    name="message"
                    rows={4}
                    placeholder="Tell us about any recent updates, special features, or specific questions about your property"
                    className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-primary focus:border-primary"
                  ></textarea>
                </div>
