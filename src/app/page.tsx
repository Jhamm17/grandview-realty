        ...
        <div className="container-padding max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
            <div className="space-y-8">
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-[#081d36] leading-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
            <div className="space-y-6">
              <div className="bg-gradient-to-r from-[#081d36]/10 to-[#081d36]/5 rounded-2xl p-8">
                <h4 className="text-2xl font-bold text-[#081d36] mb-4">Local Expertise</h4>
              ...
              <div className="bg-gradient-to-r from-[#081d36]/5 to-[#081d36]/10 rounded-2xl p-8">
                <h4 className="text-2xl font-bold text-[#081d36] mb-4">Maximum Value</h4>
                <p className="text-gray-700 leading-relaxed">
